...
init([]) ->
    Name = pgsql_conn_pool_config:get_pool_name(),
    PoolArgs = pgsql_conn_pool_config:get_pool_args(),
    WorkerArgs = pgsql_conn_pool_config:get_worker_args(),
