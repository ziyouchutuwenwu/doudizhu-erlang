...
init([]) ->
    Name = node_caller_pool_config:get_pool_name(),
    PoolArgs = node_caller_pool_config:get_pool_args(),
    WorkerArgs = node_caller_pool_config:get_worker_args(),
