...
init([]) ->
    Name = desk_working_pool_config:get_pool_name(),
    PoolArgs = desk_working_pool_config:get_pool_args(),
    WorkerArgs = desk_working_pool_config:get_worker_args(),
