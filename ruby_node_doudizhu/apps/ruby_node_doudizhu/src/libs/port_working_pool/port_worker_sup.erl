...
init([]) ->
    Name = port_working_pool_config:get_pool_name(),
    PoolArgs = port_working_pool_config:get_pool_args(),
    WorkerArgs = port_working_pool_config:get_worker_args(),
